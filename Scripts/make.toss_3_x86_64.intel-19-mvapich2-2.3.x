export CXX=/usr/tce/packages/intel/intel-19.0.0/bin/icpc;
export CC=/usr/tce/packages/intel/intel-19.0.0/bin/icc;
...
gmake clean; \
gmake \
PREFIX=`pwd`/test_install/toss_3_x86_64/intel-19-mvapich2-2.3 \
