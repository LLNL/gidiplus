...
void main2( LUPI_maybeUnused int argc, LUPI_maybeUnused char **argv ) {
    ...
    argumentParser.add<LUPI::Positional>( "PA3", "Third positional argument with 3 required value", 3, 3 );
    argumentParser.add<LUPI::Positional>( "PA4", "Fourth positional argument with 1 required value" );
    argumentParser.add<LUPI::Positional>( "PA5", "Fourth positional argument with 1 required value", 3, 5 );
}
