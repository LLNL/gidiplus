...
Form *parseExternalFilesSuite( Construction::Settings const &a_construction, GIDI::Suite *a_parent, pugi::xml_node const &a_node, PoPI::Database const &a_pops,
                PoPI::Database const &a_internalPoPs, std::string const &a_name, Styles::Suite const *a_styles ) {

    Form *form = NULL;

    if( a_name == externalFileMoniker ) {
        form = new ExternalFile( a_node, a_parent ); }
    else {
...
Form *parseStylesSuite( Construction::Settings const &a_construction, GIDI::Suite *a_parent, pugi::xml_node const &a_node, PoPI::Database const &a_pops, 
                PoPI::Database const &a_internalPoPs, std::string const &a_name, Styles::Suite const *a_styles ) {
...
Form *parseTransportablesSuite( Construction::Settings const &a_construction, Suite *a_parent, pugi::xml_node const &a_node, PoPI::Database const &a_pops, 
                PoPI::Database const &a_internalPoPs, std::string const &a_name, Styles::Suite const *a_styles ) {
...
Form *parseReaction( Construction::Settings const &a_construction, Suite *a_parent, pugi::xml_node const &a_node, PoPI::Database const &a_pops, 
                PoPI::Database const &a_internalPoPs, std::string const &a_name, Styles::Suite const *a_styles ) {
...
Form *parseOrphanProduct( Construction::Settings const &a_construction, Suite *a_parent, pugi::xml_node const &a_node, PoPI::Database const &a_pops,
                PoPI::Database const &a_internalPoPs, std::string const &a_name, Styles::Suite const *a_styles ) {
...
Form *parseReactionType( std::string const &a_moniker, Construction::Settings const &a_construction, Suite *a_parent, pugi::xml_node const &a_node, PoPI::Database const &a_pops,
                PoPI::Database const &a_internalPoPs, std::string const &a_name, Styles::Suite const *a_styles ) {
...
Form *parseSumsMultiplicitiesSuite( Construction::Settings const &a_construction, Suite *a_parent, pugi::xml_node const &a_node, PoPI::Database const &a_pops, 
    ...
    if( a_construction.parseMode( ) == Construction::ParseMode::outline ) return( NULL );
...
Form *parseDoubleDifferentialCrossSectionSuite( Construction::Settings const &a_construction, Suite *a_parent, pugi::xml_node const &a_node, PoPI::Database const &a_pops, 
                PoPI::Database const &a_internalPoPs, std::string const &a_name, Styles::Suite const *a_styles ) {

    if( a_construction.parseMode( ) == Construction::ParseMode::outline ) return( NULL );
    if( a_construction.parseMode( ) == Construction::ParseMode::multiGroupOnly ) return( NULL );
...
Form *parseScatteringAtom( Construction::Settings const &a_construction, Suite *a_parent, pugi::xml_node const &a_node, PoPI::Database const &a_pops,
                PoPI::Database const &a_internalPoPs, std::string const &a_name, Styles::Suite const *a_styles ) {
...
Form *parseCrossSectionSuite( Construction::Settings const &a_construction, Suite *a_parent, pugi::xml_node const &a_node, PoPI::Database const &a_pops, 
                PoPI::Database const &a_internalPoPs, std::string const &a_name, Styles::Suite const *a_styles ) {

    if( a_construction.parseMode( ) == Construction::ParseMode::outline ) return( NULL );
    if( ( a_construction.parseMode( ) == Construction::ParseMode::multiGroupOnly ) && ( a_name != gridded1dMoniker ) ) return( NULL );
    if( ( a_construction.parseMode( ) == Construction::ParseMode::MonteCarloContinuousEnergy ) && ( a_name != Ys1dMoniker ) ) return( NULL );

// Form not parsed is CoulombPlusNuclearElastic.
    Form *form = NULL;

    if( a_name == resonancesWithBackgroundMoniker ) {
        return( new Functions::ResonancesWithBackground1d( a_construction, a_node, a_parent ) ); }
    else if( a_name == TNSL1dMoniker ) {
        form = new Functions::ThermalNeutronScatteringLaw1d( a_construction, a_node, a_parent ); }
    else if( a_name == URR_probabilityTables1ddMoniker ) {
        form = new Functions::URR_probabilityTables1d( a_construction, a_node, a_parent ); }
    else if( a_name == CoulombPlusNuclearElasticMoniker ) {
        }
    else if( a_name == CoulombPlusNuclearElasticMoniker ) {
        }
...
Form *parseDelayedNeutronsSuite( Construction::Settings const &a_construction, Suite *a_parent, pugi::xml_node const &a_node, PoPI::Database const &a_pops,
                PoPI::Database const &a_internalPoPs, std::string const &a_name, Styles::Suite const *a_styles ) {
...
Form *parseFissionEnergyReleasesSuite( Construction::Settings const &a_construction, Suite *a_parent, pugi::xml_node const &a_node, PoPI::Database const &a_pops,
                PoPI::Database const &a_internalPoPs, std::string const &a_name, Styles::Suite const *a_styles ) {

    return( new Functions::FissionEnergyRelease( a_construction, a_node, a_parent ) );
}
...
Form *parseRateSuite( Construction::Settings const &a_construction, Suite *a_parent, pugi::xml_node const &a_node, PoPI::Database const &a_pops,
                PoPI::Database const &a_internalPoPs, std::string const &a_name, Styles::Suite const *a_styles ) {
...
Form *parseAvailableSuite( Construction::Settings const &a_construction, Suite *a_parent, pugi::xml_node const &a_node, PoPI::Database const &a_pops, 
                PoPI::Database const &a_internalPoPs, std::string const &a_name, Styles::Suite const *a_styles ) {
...
Form *parseQSuite( Construction::Settings const &a_construction, Suite *a_parent, pugi::xml_node const &a_node, PoPI::Database const &a_pops, 
                PoPI::Database const &a_internalPoPs, std::string const &a_name, Styles::Suite const *a_styles ) {
...
Form *parseProductSuite( Construction::Settings const &a_construction, Suite *a_parent, pugi::xml_node const &a_node, PoPI::Database const &a_pops, 
                PoPI::Database const &a_internalPoPs, std::string const &a_name, Styles::Suite const *a_styles ) {
...
Form *parseMultiplicitySuite( Construction::Settings const &a_construction, Suite *a_parent, pugi::xml_node const &a_node, PoPI::Database const &a_pops, 
                PoPI::Database const &a_internalPoPs, std::string const &a_name, Styles::Suite const *a_styles ) {

    if( a_construction.parseMode( ) == Construction::ParseMode::outline ) return( NULL );

    if( a_name == branching1dMoniker ) return( new Functions::Branching1d( a_construction, a_node, a_parent ) );
...
Form *parseDistributionSuite( Construction::Settings const &a_construction, Suite *a_parent, pugi::xml_node const &a_node, PoPI::Database const &a_pops, 
                PoPI::Database const &a_internalPoPs, std::string const &a_name, Styles::Suite const *a_styles ) {

    if( a_construction.parseMode( ) == Construction::ParseMode::outline ) return( NULL );
    if( a_name == multiGroup3dMoniker ) {
        if( ( a_construction.parseMode( ) == Construction::ParseMode::MonteCarloContinuousEnergy ) || 
            ( a_construction.parseMode( ) == Construction::ParseMode::excludeProductMatrices ) ) return( NULL ); }
    else {
        if( a_construction.parseMode( ) == Construction::ParseMode::multiGroupOnly ) return( NULL );
    }
...
//  Distributions not parsed are CoulombPlusNuclearElasticMoniker and LLNLLegendreMoniker.
    ...
    if( a_name == multiGroup3dMoniker ) {
        form = new Distributions::MultiGroup3d( a_construction, a_node, a_parent ); }
    else if( a_name == angularTwoBodyMoniker ) {
        form = new Distributions::AngularTwoBody( a_construction, a_node, a_parent ); }
    else if( a_name == uncorrelatedMoniker ) {
        form = new Distributions::Uncorrelated( a_construction, a_node, a_parent ); }
    else if( a_name == KalbachMannMoniker ) {
        form = new Distributions::KalbachMann( a_construction, a_node, a_parent ); }
    else if( a_name == energyAngularMoniker ) {
        form = new Distributions::EnergyAngular( a_construction, a_node, a_parent ); }
    else if( a_name == energyAngularMCMoniker ) {
        form = new Distributions::EnergyAngularMC( a_construction, a_node, a_parent ); }
    else if( a_name == angularEnergyMoniker ) {
        form = new Distributions::AngularEnergy( a_construction, a_node, a_parent ); }
    else if( a_name == angularEnergyMCMoniker ) {
        form = new Distributions::AngularEnergyMC( a_construction, a_node, a_parent ); }
    else if( a_name == LLNLAngularEnergyMoniker ) {
        form = new Distributions::LLNLAngularEnergy( a_construction, a_node, a_parent ); }
    else if( a_name == coherentPhotonScatteringMoniker ) {
        form = new Distributions::CoherentPhotoAtomicScattering( a_construction, a_node, a_parent ); }
    else if( a_name == incoherentPhotonScatteringMoniker ) {
        form = new Distributions::IncoherentPhotoAtomicScattering( a_construction, a_node, a_parent ); }
    else if( a_name == TNSLMoniker ) {
        form = new Distributions::ThermalNeutronScatteringLaw( a_construction, a_node, a_parent ); }
    else if( a_name == branching3dMoniker ) {
        form = new Distributions::Branching3d( a_construction, a_node, a_parent ); }
    else if( a_name == referenceMoniker ) {
        form = new Distributions::Reference3d( a_construction, a_node, a_parent ); }
    else if( a_name == unspecifiedMoniker ) {
        form = new Distributions::Unspecified( a_construction, a_node, a_parent ); }
    else if( a_name == CoulombPlusNuclearElasticMoniker ) {
        }
...
Form *parseAverageEnergySuite( Construction::Settings const &a_construction, Suite *a_parent, pugi::xml_node const &a_node, PoPI::Database const &a_pops, 
                PoPI::Database const &a_internalPoPs, std::string const &a_name, Styles::Suite const *a_styles ) {
...
Form *parseAverageMomentumSuite( Construction::Settings const &a_construction, Suite *a_parent, pugi::xml_node const &a_node, PoPI::Database const &a_pops, 
                PoPI::Database const &a_internalPoPs, std::string const &a_name, Styles::Suite const *a_styles ) {
...
Functions::Function1dForm *data1dParse( Construction::Settings const &a_construction, pugi::xml_node const &a_node, Suite *a_parent ) {

    Functions::Function1dForm *form = NULL;
    std::string name( a_node.name( ) );

    if( name == constant1dMoniker ) {
        form = new Functions::Constant1d( a_construction, a_node, a_parent ); }
    else if( name == XYs1dMoniker ) {
        form = new Functions::XYs1d( a_construction, a_node, a_parent ); }
    else if( name == Ys1dMoniker ) {
        form = new Functions::Ys1d( a_construction, a_node, a_parent ); }
    else if( name == polynomial1dMoniker ) {
        form = new Functions::Polynomial1d( a_construction, a_node, a_parent ); }
    else if( name == LegendreMoniker ) {
        form = new Functions::Legendre1d( a_construction, a_node, a_parent ); }
    else if( name == regions1dMoniker ) {
        form = new Functions::Regions1d( a_construction, a_node, a_parent ); }
    else if( name == gridded1dMoniker ) {
        form = new Functions::Gridded1d( a_construction, a_node, a_parent ); }
    else if( name == referenceMoniker ) {
        form = new Functions::Reference1d( a_construction, a_node, a_parent ); }
    else if( name == xs_pdf_cdf1dMoniker ) {
        form = new Functions::Xs_pdf_cdf1d( a_construction, a_node, a_parent ); }
    else if( name == unspecified1dMoniker ) {
        form = new Functions::Unspecified1d( a_construction, a_node, a_parent ); }
    else {
...
Functions::Function2dForm *data2dParse( Construction::Settings const &a_construction, pugi::xml_node const &a_node, Suite *a_parent ) {

    Functions::Function2dForm *form = NULL;
    std::string name( a_node.name( ) );

    if( name == XYs2dMoniker ) {
        form = new Functions::XYs2d( a_construction, a_node, a_parent ); }
    else if( name == recoilMoniker ) {
        form = new Functions::Recoil2d( a_construction, a_node, a_parent ); }
    else if( name == isotropic2dMoniker ) {
        form = new Functions::Isotropic2d( a_construction, a_node, a_parent ); }
    else if( name == discreteGammaMoniker ) {
        form = new Functions::DiscreteGamma2d( a_construction, a_node, a_parent ); }
    else if( name == primaryGammaMoniker ) {
        form = new Functions::PrimaryGamma2d( a_construction, a_node, a_parent ); }
    else if( name == generalEvaporationMoniker ) {
        form = new Functions::GeneralEvaporation2d( a_construction, a_node, a_parent ); }
    else if( name == simpleMaxwellianFissionMoniker ) {
        form = new Functions::SimpleMaxwellianFission2d( a_construction, a_node, a_parent ); }
    else if( name == evaporationMoniker ) {
        form = new Functions::Evaporation2d( a_construction, a_node, a_parent ); }
    else if( name == WattMoniker ) {
        form = new Functions::Watt2d( a_construction, a_node, a_parent ); }
    else if( name == MadlandNixMoniker ) {
        form = new Functions::MadlandNix2d( a_construction, a_node, a_parent ); }
    else if( name == weightedFunctionalsMoniker ) {
        form = new Functions::WeightedFunctionals2d( a_construction, a_node, a_parent ); }
    else if( name == NBodyPhaseSpaceMoniker ) {
        form = new Functions::NBodyPhaseSpace2d( a_construction, a_node, a_parent ); }
    else if( name == regions2dMoniker ) {
        form = new Functions::Regions2d( a_construction, a_node, a_parent ); }
    else {
...
Functions::Function3dForm *data3dParse( Construction::Settings const &a_construction, pugi::xml_node const &a_node, Suite *a_parent ) {

    Functions::Function3dForm *form = NULL;
    std::string name( a_node.name( ) );

    if( name == XYs3dMoniker ) {
        form = new Functions::XYs3d( a_construction, a_node, a_parent ); }
    else if( name == gridded3dMoniker ) {
        form = new Functions::Gridded3d( a_construction, a_node ); }
    else {
