...
#ifndef PoPs_hpp_included
#define PoPs_hpp_included 1
...
#define PoPs_AMU2MeV_c2 931.494028
#define PoPs_electronMass_MeV_c2 0.5109989461
...
enum PoPs_class { class_gaugeBoson, class_lepton, class_baryon, class_unorthodox,
        class_nuclide, class_nucleus, class_chemicalElement, class_isotope, 
        class_alias, class_metaStable };
...
#define PoPs_decayMode_electroMagnetic "electroMagnetic"

enum pq_class { class_double, class_integer, class_fraction, class_string, class_shell };
...
class Base {
    ...
    public:
        Base( std::string const &a_id, PoPs_class a_class );
        Base( pugi::xml_node const &a_node, std::string const &a_label, PoPs_class a_class );
        virtual ~Base( );

        std::string const &ID( void ) const { return( m_id ); }
        int index( void ) const { return( m_index ); }
        void index( int a_index ) { m_index = a_index; }
        PoPs_class Class( void ) const { return( m_class ); }
        virtual bool isParticle( ) const { return( true ); }
        virtual bool isAlias( void ) const { return( false ); }
        virtual bool isMetaStableAlias( void ) const { return( false ); }

        virtual bool isGaugeBoson( ) const { return( false ); }
        virtual bool isLepton( ) const { return( false ); }
        virtual bool isBaryon( ) const { return( false ); };
        virtual bool isUnorthodox( ) const { return( false ); }
        virtual bool isNucleus( ) const { return( false ); }
        virtual bool isNuclide( ) const { return( false ); }
        virtual bool isIsotope( ) const { return( false ); }
        virtual bool isChemicalElement( ) const { return( false ); }
};
...
class IDBase : public Base {
    ...
    public:
        IDBase( std::string const &a_id, PoPs_class a_class );
        IDBase( pugi::xml_node const &a_node, PoPs_class a_class );
...
class SymbolBase : public Base {
    ...
    public:
        SymbolBase( pugi::xml_node const &a_node, PoPs_class a_class );
        ~SymbolBase( );
...
class DecayMode {
    ...
    public:
        ...
        void calculateNuclideGammaBranchStateInfo( PoPs::Database const &a_pops, NuclideGammaBranchStateInfo &a_nuclideGammaBranchStateInfo ) const ;
        void toXMLList( std::vector<std::string> &a_XMLList, std::string const &a_indent1 ) const ;
};
...
class Particle : public IDBase {
    ...
    public:
        Particle( pugi::xml_node const &a_node, PoPs_class a_class, std::string const &a_family, int a_hasNucleus = 0 );
        virtual ~Particle( );
...
class GaugeBoson : public Particle {
    ...
    public:
        ...
        bool isGaugeBoson( ) const { return( true ); }
};
...
class Lepton : public Particle {
    ...
    public:
        ...
        bool isLepton( ) const { return( true ); }
...
class Baryon : public Particle {
    ...
    public:
        ...
        bool isBaryon( ) const { return( true ); }
};
...
class Unorthodox : public Particle {
    ...
    public:
        ...
        bool isUnorthodox( ) const { return( true ); }
};
...
class Nucleus : public Particle {
    ...
    public:
        ...
        bool isNucleus( ) const { return( true ); }
...
class Nuclide : public Particle {
    ...
    public:
        ...
        bool isNuclide( ) const { return( true ); }
        int Z( void ) const;
        int A( void ) const;
        ...
        void calculateNuclideGammaBranchStateInfos( PoPs::Database const &a_pops, NuclideGammaBranchStateInfos &a_nuclideGammaBranchStateInfos ) const ;
        virtual void toXMLListExtraElements( std::vector<std::string> &a_XMLList, std::string const &a_indent1 ) const ;
};
...
class Isotope : public SymbolBase {
    ...
    public:
        ...
        bool isIsotope( ) const { return( true ); }
...
class ChemicalElement : public SymbolBase {
    ...
    public:
       ChemicalElement( pugi::xml_node const &a_node, Database *a_DB, Database *a_parent );
        ...
        bool isChemicalElement( ) const { return( true ); }
        int Z( void ) const { return( m_Z ); }
...
class Alias : public IDBase {
    ...
    public:
        Alias( pugi::xml_node const &a_node, Database *a_DB, PoPs_class a_class = class_alias );
        virtual ~Alias( );

        std::string const &pid( void ) const { return( m_pid ); }
        int pidIndex( void ) const { return( m_pidIndex ); }
        void set_pidIndex( int a_index ) { m_pidIndex = a_index; }
        bool isAlias( void ) const { return( true ); }
        void toXMLList( std::vector<std::string> &a_XMLList, std::string const &a_indent1 ) const ;
};
...
class MetaStable : public Alias {
    ...
    public:
        ...
        bool isMetaStableAlias( void ) const { return( true ); }
        void toXMLList( std::vector<std::string> &a_XMLList, std::string const &a_indent1 ) const ;
};
...
#endif      // End of PoPs_hpp_included
