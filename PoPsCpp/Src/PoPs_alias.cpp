...
=========================================================
*/
Alias::Alias( pugi::xml_node const &a_node, Database *a_DB, enum PoPs_class a_class ) :
        IDBase( a_node, a_class ),
        m_pid( a_node.attribute( "pid" ).value( ) ),
        m_pidIndex( -1 ) {

    if( a_class == class_alias ) addToDatabase( a_DB );
}
/*
=========================================================
*/
...
MetaStable::MetaStable( pugi::xml_node const &a_node, Database *a_DB ) :
        Alias( a_node, a_DB, class_metaStable ),
