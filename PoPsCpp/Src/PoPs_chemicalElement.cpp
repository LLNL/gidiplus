...
ChemicalElement::ChemicalElement( pugi::xml_node const &a_node, Database *a_DB, Database *a_parent ) :
        SymbolBase( a_node, class_chemicalElement ),
...
=========================================================
*/
void ChemicalElement::calculateNuclideGammaBranchStateInfos( PoPs::Database const &a_pops, NuclideGammaBranchStateInfos &a_nuclideGammaBranchStateInfos ) const {
