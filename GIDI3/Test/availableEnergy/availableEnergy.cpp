...
int main( int argc, char **argv ) {
    ...
    try {
        GIDI::Vector availableEnergy = protare->multiGroupAvailableEnergy( settings, particles );
    ...
    for( std::size_t index = 0; index < protare->numberOfReactions( ); ++index ) {
        ...
        GIDI::Vector availableEnergy = reaction->multiGroupAvailableEnergy( settings, particles );
