...
void Sums::parse( Construction::Settings const &a_construction, pugi::xml_node const &a_node, PoPs::Database const &a_pops, PoPs::Database const &a_internalPoPs ) {
...
Base::Base( Construction::Settings const &a_construction, pugi::xml_node const &a_node, PoPs::Database const &a_pops, PoPs::Database const &a_internalPoPs,
                formType a_type ) :
        Form( a_node, a_type ),
...
CrossSectionSum::CrossSectionSum( Construction::Settings const &a_construction, pugi::xml_node const &a_node, PoPs::Database const &a_pops, PoPs::Database const &a_internalPoPs ) :
        Base( a_construction, a_node, a_pops, a_internalPoPs, f_crossSectionSum ),
...
MultiplicitySum::MultiplicitySum( Construction::Settings const &a_construction, pugi::xml_node const &a_node, PoPs::Database const &a_pops, PoPs::Database const &a_internalPoPs ) :
        Base( a_construction, a_node, a_pops, a_internalPoPs, f_multiplicitySum ),
