...
PhysicalQuantity const &CrossSectionReconstructed::temperature( ) const {
    ...
    if( style == NULL ) throw std::runtime_error( "No style with temperature." );
...
MultiGroup::MultiGroup( Construction::Settings const &a_construction, pugi::xml_node const &a_node, PoPs::Database const &a_pops, PoPs::Database const &a_internalPoPs, GIDI::Suite *a_parent ) : 
        Base( a_node, a_parent ),
...
std::vector<double> const &MultiGroup::groupBoundaries( std::string const &a_productID ) const {
    ...
    throw std::runtime_error( "MultiGroup::groupBoundaries: product index not found" );
}
...
HeatedMultiGroup::HeatedMultiGroup( Construction::Settings const &a_construction, pugi::xml_node const &a_node, PoPs::Database const &a_pops, GIDI::Suite *a_parent ) : 
        Base( a_node, a_parent ),
...
MultiGroup const &HeatedMultiGroup::multiGroup( ) const {
    ...
    while( form == NULL ) throw std::runtime_error( "parameters style not found." );

    MultiGroup const *_multiGroup = dynamic_cast<MultiGroup const *>( form );
    if( _multiGroup == NULL ) throw std::runtime_error( "parameter not a multiGroup style not found." );
...
SnElasticUpScatter::SnElasticUpScatter( pugi::xml_node const &a_node, PoPs::Database const &a_pops, GIDI::Suite *a_parent ) :
        Base( a_node, a_parent ),
...
GriddedCrossSection::GriddedCrossSection( Construction::Settings const &a_construction, pugi::xml_node const &a_node, PoPs::Database const &a_pops, GIDI::Suite *a_parent ) :
        Base( a_node, a_parent ),
...
URR_probabilityTables::URR_probabilityTables( Construction::Settings const &a_construction, pugi::xml_node const &a_node, PoPs::Database const &a_pops, GIDI::Suite *a_parent ) :
        Base( a_node, a_parent ) {
