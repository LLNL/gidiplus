...
FissionEnergyRelease::FissionEnergyRelease( Construction::Settings const &a_construction, pugi::xml_node const &a_node, Suite *a_parent ) :
        Function1dForm( a_construction, a_node, f_fissionEnergyRelease1d, a_parent ) {
...
Vector FissionEnergyRelease::multiGroupQ( Settings::MG const &a_settings, Settings::Particles const &a_particles ) const {

    Vector vector( 0 );

    if( a_settings.delayedNeutrons( ) ) {
