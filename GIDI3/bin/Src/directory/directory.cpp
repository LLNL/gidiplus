...
int main( int argc, char **argv ) {
    ...
    std::vector<GIDI::ProtareBaseEntry const *> protareEntries = map.directory( projectileID, targetID, evaluation );

    for( std::size_t i1 = 0; i1 < protareEntries.size( ); ++i1 ) {
        GIDI::ProtareBaseEntry const *protareEntry = protareEntries[i1];
