...
#define gpuErrchk(ans) { gpuAssert((ans), __FILE__, __LINE__); }
    ...
    #define MCGIDI_WARP_SIZE 32
    #define MCGIDI_THREADID threadIdx.x
    #ifdef __CUDA_ARCH__
        #define MCGIDI_ON_GPU 1
    #endif
...
//    #define MCGIDI_HOST_DEVICE_END _Pragma("omp end declare target")
    ...
    #define MCGIDI_THROW(arg) printf("%s", arg)
    #define MCGIDI_WARP_SIZE 1
    #define MCGIDI_THREADID 
inline void gpuAssert(int code, const char *file, int line, bool abort=true) {}
    ...
    #define MCGIDI_HOST_DEVICE __host__ __device__
    //#define MCGIDI_THROW(arg) printf("%s", arg)
    #define MCGIDI_THROW(arg) 
    #define MCGIDI_WARP_SIZE 1
    #define MCGIDI_THREADID hipThreadIdx_x
