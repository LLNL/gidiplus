...
============================================================
*/
MC::MC( PoPI::Database const &a_pops, std::string const &a_projectileID, GIDI::Styles::Suite const *a_styles, std::string const &a_label, GIDI::Transporting::DelayedNeutrons a_delayedNeutrons, double a_energyDomainMax ) :
...
=========================================================
*/
void MC::crossSectionLookupMode( LookupMode::Data1d a_crossSectionLookupMode ) {
...
=========================================================
*/
void MC::other1dDataLookupMode( LookupMode::Data1d a_other1dDataLookupMode ) {
...
=========================================================
*/
void MC::distributionLookupMode( LookupMode::Distribution a_distributionLookupMode ) {
...
=========================================================
*/
void MC::setUpscatterModelA( std::string const &a_upscatterModelALabel ) {
